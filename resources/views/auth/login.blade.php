                                ...
                                <div class="p-5">
                                    ...
                                    <form class="user" action="{{ route('login.post') }}" method="POST">
                                        ...
                                        <div class="form-group">
                                            <input type="email" name="email" required autofocus class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Email Address...">
                                            @if ($errors->has('email'))
